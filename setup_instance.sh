...
export securityGroupId=$(aws ec2 create-security-group --group-name $name-security-group --description "SG for udacity-dl machine" --vpc-id $vpcId --query 'GroupId' --output text)
# ssh
